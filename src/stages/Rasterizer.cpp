...
void Rasterizer::rasterizeTrianglePerTile(const Triangle& tri,
    ...
    float sy0 = (tri.v[0].ndcY + 1.0f) * 0.5f * static_cast<float>(m_viewportHeight);
    float sx1 = (tri.v[1].ndcX + 1.0f) * 0.5f * static_cast<float>(m_viewportWidth);
    float sy1 = (tri.v[1].ndcY + 1.0f) * 0.5f * static_cast<float>(m_viewportHeight);
    float sx2 = (tri.v[2].ndcX + 1.0f) * 0.5f * static_cast<float>(m_viewportWidth);
    float sy2 = (tri.v[2].ndcY + 1.0f) * 0.5f * static_cast<float>(m_viewportHeight);
